...
export default function DepartmnetAdd() {
  const {
    control,
    register,
    handleSubmit,
  ...
  const fetchCollege = async (locationId) => {
    try {
      ...
      const getCollege = await axios.post(
        `${api}/college/location_id/${locationId}`
      );
  ...
  const onSubmit = async (data) => {
    try {
      const result = await axios.post(`${api}/department-submit`, data);
            ...
            <div>
              ...
              <input
                ...
                {...register("department", {
                  ...
                  pattern: {
                    value: /^[A-Z.\s]+$/,
                    message: "Capital Letters Only Allowed",
                  },
