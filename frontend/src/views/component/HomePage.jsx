      ...
      <div className="mb-0">
        ...
        <div className="relative w-full h-screen mt-20 overflow-hidden">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center p-10 ">
            <h1 className="text-5xl sm:text-6xl md:text-7xl italic font-extrabold mb-12 tracking-wide bg-gradient-to-r from-gray-800 via-white-500 to-blue-400 bg-clip-text drop-shadow-2xl text-center">
              Achievements
            </h1>
